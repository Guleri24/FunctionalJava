 ...
 * @see <a herf="https://uva.onlinejudge.org/external/117/p11764.pdf"target="_top">JumpingMario</a>
 */
...
public class JumpingMario {
    ...
    public static <A, B> B foldLeft(Stream<A> a, B z, BiFunction<A, B, B> biFunction) {
        B b = z;
    ...
    public static void main(String[] args) {
        ...
        // TODO : replace Scanner with BufferReader or FastReader Class
        Scanner sc = new Scanner(System.in);
        int t = Integer.parseInt(sc.nextLine());

        BiFunction<Pair<Integer, Integer>, Pair<Integer, Integer>, Pair<Integer, Integer>> bF =
                (lpair, pair) -> {
                    if (lpair._1.equals(lpair._2)) return pair;
                    else {
